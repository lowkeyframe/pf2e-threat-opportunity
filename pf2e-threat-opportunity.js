...
Hooks.on('renderChatMessage', async (message, html, data) => {
    ...
    if ([-1, -2, -3].includes(difference) || [7, 8, 9].includes(difference)) {
        detailText = game.i18n.localize("PF2E_THREAT_OPPORTUNITY.Opportunity"); // Assuming localization key exists or will be added
    ...
    // if = dc or +2 (difference: 0, 2)
        ...
        detailText = game.i18n.localize("PF2E_THREAT_OPPORTUNITY.Threat"); // Assuming localization key exists or will be added
        detailClass = "threat";
    }
    // --- END NEW LOGIC ---
